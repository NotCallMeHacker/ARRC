...
einleitung 			= "Am 25.04.2026 treffen Deutsche Kräfte in Sinesti, Moldawien ein, um die dort stationierten Truppen zu unterstützen. <br/><br/>Die Lage in der Region ist angespannt, da feindliche Kräfte versuchen, die Kontrolle über das Gebiet zu erlangen.";
